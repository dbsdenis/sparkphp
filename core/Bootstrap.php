...
class Bootstrap
{
    ...
    public function run(): void
    {
        ...
        foreach (['Request','Response','Router','Middleware','View','Cache','Database','Schema','Migration','Seeder','Model','EventEmitter','Validator','Mailer','Queue','SparkInspectorStorage','SparkInspector'] as $class) {
